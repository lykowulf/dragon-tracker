...
namespace TestTracker2020.Controllers
{
    ...
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Comment,TicketId")] TicketComment ticketComment)//bind is bringinng properties from the front to the backend
        {
            if (ModelState.IsValid)
            {
                ...
                // this is how i get the current id of the logged in user.
                ticketComment.UserId = _userManager.GetUserId(User);//captures the comment from the back end and not front end so needs to be removed from the bind.
